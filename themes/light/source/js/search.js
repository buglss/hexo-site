    ...
    $.ajax({
        ...
        success: function(xmlResponse) {
            ...
            $input.addEventListener('input', function() {
                ...
                // if(numOfPostFound > 0) {
                //     summary = numOfPostFound + " sonuç bulundu";
                //     // if(numOfPostFound > 1) {
                ...
                // }
                //"<p class=\"\">" + summary + "</ul>";
                if(numOfPostFound === 0) $resultContent.innerHTML = '<p class="summary">Sonuç bulunamadı</p>' + str;
                else $resultContent.innerHTML = str;
            });
        }
    });
}